	...
	<div id="loginDiv"
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand animated fadeInDownBig" href="/agg/home"><img
					src="/assets/images/logo.png" alt="vOne HTML5 template"></a>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-7 col-sm-12">
					<form class="form-corevalue">
						...
						<p class="mar-bot" style="color: black; font-size: 16px;">Our
							programs are designed for the needs of the dealer and their
							customers, unlike some warranty programs that force you to fit to
							their needs.</p>
						<p class="mar-bot" style="color: black; font-size: 16px;">We
							have products to help dealers get trade-ins with remaining
							warranty and sell used machines with warranty. We have products
							to allow leases to be extended with coverage to match. As quickly
							as the market changes and the needs of customers change, we can
							nimbly provide solutions.</p>

						<p class="mar-bot" style="color: black; font-size: 16px;">We
							have tailored programs to increase service department revenue
							like our ServiceDrive product which provides a year's coverage on
							fully serviced and inspected equipment for machines and
							implements that are up to 10-years old with 5,000 hours.</p>
						<p class="mar-bot" style="color: black; font-size: 16px;">If
							we don't already have a product that works for you, we'll do our
							level best to work with you to create a customized solution.</p>
          ...
          <div class="panel-body">
            <p>Lorem ipsum dolor amet, consectetur adipiscing elit. Aenean leo lectus sollicitudin convallis eget libero. Aliquam laoreet tellus ut libero semper, egestas velit malesuada. Sed non risus eget dolor amet vestibulum ullamcorper. Integer feugiat molestie.</p>
					...
					<div class="col-md-4 panel contact">
						...
						<div class="panel-body">
							<p>Ag Guard LLC, 21295 Hollingsworth Road, Tonganoxie, KS
								66086.</p>
							<ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 panel">
						<div class="panel-body">
							<p class="simplenav">
								<a href="/agg/home">Home</a> | <a href="/agg/whoWeAre">Who
									we are</a> | <a href="/agg/register">Register</a> | <a
									href="/agg/aboutRisk">About Risk</a> | <a
									href="/agg/momsPinkTractor">Mom's Pink Tractor</a>
							</p>
						</div>
					</div>
					<div class="col-md-6 panel">
						<div class="panel-body">
							<p class="text-right">Copyright &copy; 2016 - 2017.
								agguard.com</p>
						</div>
					</div>
				</div>
