...
<!-- /.navbar --> 
	...
	<div class="inner-main">
		...
		<p>Our team's depth and breadth of knowledge gives us a distinct advantage.  Our actual goal when we assembled our management team was to get "rock stars" in the industry with stellar credentials and impeccable integrity.  And we succeeded.</p>
			<p>Our founder, Gregg Denholm literally invented 3rd party extended coverage on Ag equipment and our Director of Manufacturer Relations, Dexter Schaible, is known throughout the industry for his product knowledge and integrity.  Adrian Powell, who leads our claims department, is recognized as one of the top people in Ag Equipment service and reliability.  Dane Lee's entire career in risk management has been based on integrity and customer-focused processes.</p>
			
			<p>We are also good with numbers; our sophisticated, three-dimensional approach to pricing is based on our extensive claims history and Ag equipment knowledge; this allows us to develop pricing based on our actual risk instead of just charging "what the market will bear".   That means our pricing is fair to everyone involved; supporting greater success for the dealer, the farmer and us.</p>
