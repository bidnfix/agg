...
<article class="col-md-9 maincontent">
	<form class="form-horizontal" name="quoteInfoForm" id="quoteInfoForm" ng-submit="submitProgramAsDel()" novalidate angular-validator>
                   ...
                   <div class="col-xs-12 agf1 main-login pad10-top">
                     <div class="col-md-6 no-pad pad10-right">
                       <div class="form-group">
                         ...
                         <select class="form-control" name="programName" ng-model="program.programDO"
												ng-options="program.name for program in programList"
												ng-change="getProgDetails(program.programDO)" validate-on="dirty" required="required" ng-disabled="disabled">
