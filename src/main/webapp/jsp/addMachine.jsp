	...
	<div class="inner-main" ng-controller="machineController">
		...
		<!-- 	<h2>Registration Form</h2> -->
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="machine" ng-model="machine.manufacturerDO" ng-options="machine.name for machine in manufacturerList" class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="machineType" ng-model="machine.machineTypeDO" ng-options="machineType.name for machineType in machineTypeList" class="form-control"></select> 
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				<select name="groupId" ng-model="machine.groupDO" id="groupId" required="required" ng-options="groupDO.groupId for groupDO in groupList track by groupDO.groupId" class="form-control">
