...
<!-- /.navbar --> 
	...
	<div class="inner-main">
		...
		<p>We pay claims fast and we measure our payment of claims requests in hours not months.</p>
			<p>After all, what good is the coverage if it's not there when you need it?</p>
			
			<p>The difference is in our approach.  We review claims with the intent to pay them.  We do not look for ways to deny a claim on some technicality, or to make the process so difficult and protracted that you give up.  Our approach is to be fair with you and we expect you to be fair with us.  That reflects the culture in agriculture, where a handshake still means something.</p>
