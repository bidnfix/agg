...
<!-- /.navbar --> 
	...
	<div class="inner-main">
        ...
        <h3>Who We Are</h3>
			...
			<p>Founded in 2001, AgGuard provides risk management solutions primarily to the agricultural industry. The company's principal product is extended service contracts (ESCs) on farm machines that are sold through implement dealerships.  Such contracts are sometimes referred to as extended warranties or service plans.  The company does not sell directly to consumers, but has programs that are marketed through equipment manufacturers.  AgGuard was the first third party provider of ESCs for farm equipment.</p>
			
			<h3>OUR VALUES</h3>
			<ul>
				<li>We believe our mission is to provide great products that help folks sleep easier and focus on their work. </li>
				<li>We are constantly innovating; asking what if and why not?</li>
				<li>We believe in making the complex simple.</li>
				<li>We believe that we need to own and control the primary technologies and delivery methods for our products, and participate only in markets where we can make a difference.</li>
				<li>We believe in deep relationships and collaboration with manufactures, dealers and the people using the equipment we cover-this people-based, relationship approach to business allows us to innovate and deliver in ways that others cannot.</li>
				<li>We will not settle for anything less than excellence in everything that we do.</li>
				<li>We listen and empathize with our customer-partners; we admit when we are wrong and we have the courage to change.</li>
			</ul>
			<p>These values are embedded in our organization and everything we do-it is why we are the leading provider of extended service contracts to the agricultural industry</p>
			...
			<h3>THE NEW AGGUARD BUSINESS MODEL</h3>
			<p>Prior to January 1, 2012, AgGuard's services were administered by Glynn General and backed by various companies including Lloyds of London, ASI and AmTrust.  In the first six months of 2012, AgGuard suspended sales of new contracts and completely re-engineered its products and services.</p>
			<p>As of June 1, 2012, AgGuard entered into a relationship with Wild Jay, Inc. who now guarantees the payment of valid claims on contracts sold after June 1, 2012.</p>
			<p>The relationship with Wild Jay, Inc. represented a significant change in how we do business.  The owner's of Wild Jay, Inc. own a controlling interest in AgGuard and AgGuard owns an interest in Wild Jay, Inc.  This financial relationship brings our services into complete alignment and means our client's relationship with us will be seamless.  AgGuard will remain your advocate for claims processed through the old administrators, (Glynn General and Bridge Water), but we still cannot determine the outcome of any of those claims decisions.  Ultimately those decisions are made by the reinsurance providers, (Lloyds of London, ASI and AmTrust). </p>
			<p>It was a lack of control that led us to the development of this symbiotic relationship with Wild Jay, Inc.  Wild Jay, Inc. is not focused on profits from premiums or the price of your service contract; they instead reinvest the funds not paid out in claims to provide greater security and where-with-all for paying future claims.  They seek their profits from their investment in AgGuard and interest income on the reserves.  This structural change alone reduced the cost of our contracts by as much as 18%, while providing an efficient, one-step claims process that now measures the time between claims submission and payment in hours not weeks.</p>
			...
			<ul>
				...
				<li>Because our claims managers are experts on the machines that we cover, they can quickly assess the validity of a claim.  That makes them hard to fool with a bad claim, but they want to get any valid claim paid quickly.</li>
				<li>This is a one-step process with no middlemen to delay your payment.</li>
			</ul>
