	...
	<div class="inner-main" ng-controller="programController">
		<form class="form-horizontal" role="form" ng-submit="submitProgram()">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="dealer" ng-model="program.dealerDO" ng-options="dealer.name+' - '+dealer.city group by dealer.parentDealerDO.name+' - '+dealer.parentDealerDO.city for dealer in dealerList | orderBy:'name'" class="form-control">
