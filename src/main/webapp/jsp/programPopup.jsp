	...
	<div class="modal-header">
		...
		<form class="form-horizontal" role="form" ng-submit="editProgramDetails()">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="dealer" ng-model="program.dealerDO" ng-options="dealer.name+' - '+dealer.city for dealer in dealerList | orderBy:'name' track by dealer.id" class="form-control">
