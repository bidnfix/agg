...
<!--<h3><center>Coverage Details</center></h3>-->
...
<p><strong>Equipment Service Contract Period: </strong>Coverage under this Equipment Service Contract begins on the &ldquo;Contract Inception Date&rdquo; shown in Coverage Details and expires per the &ldquo;Term&rdquo; in months or Machine Hours as indicated in Coverage Details, whichever occurs first. For &ldquo;New&rdquo; Equipment, the time and hour limits of the Term start the day the Manufacturer&rsquo;s Warranty starts and at zero (0) Hours. Coverage expires when the length of time or accumulated hours of the Term selected is reached. For &ldquo;Used&rdquo; Equipment, the time of the Term starts on the Contract Inception Date and the Hours are in addition to the hours shown on the service meter on the Contract Inception Date, as reported by the Dealer. Coverage expires when the length of time specified in the Term is reached (Expiration Date) or when the total hours on the Equipment is equal to the sum of the selected Term hours plus the hours on the Equipment when it was delivered, as reported by the Dealer.</p>
 
<p><strong>Terminology: </strong>This Contract is subject to the terms, provisions, conditions, limitations, extensions, exceptions and definitions, which are described in the Coverage, Equipment Description, Contract Holder and Dealer Information sections in Coverage Details and in the section titled &ldquo;Key Terms and Definitions&rdquo;. No person has the authority to change or to waive any of the Contract&rsquo;s provisions<strong>. (pursuant to chapter 40 of the Kansas Statutes Annotated), a warranty, or a guarantee. This Equipment Service Contract is not an insurance policy.</strong> This Contract is for the sole benefit of the Contract Holder and applies only to the Equipment described herein. <strong>Please read this Contract carefully to ensure that YOU understand each provision. This agreement requires the use of arbitration to resolve disputes, rather than jury trials or class actions, and limits remedies available to YOU in the event of a dispute.</strong></p>
...
<p><strong>EQUIPMENT/MACHINE: </strong>means the EQUIPMENT described above which is to be used to perform work as part of an enterprise used in crop production, and not used as a vehicle, i.e., not used solely for transportation, or used in construction type applications, such as mining, road building or scraper application. &nbsp;The <strong>MANUFACTURER </strong>is the original Manufacturer of the EQUIPMENT who assigns the <strong>MODEL </strong>and <strong>SERIAL NUMBER </strong>(SERIAL #).</p>
 
<p><strong>MECHANICAL BREAKDOWN or FAILURE</strong>: means the actual breaking or electronic failure of any covered part of the covered MACHINE while in ordinary use arising from to <strong>faults, attributable to manufacturing defects in workmanship or materials</strong> in such MACHINE causing sudden stoppage of the functions thereof and necessitating repair before it can resume work.</p>
 
<p><strong>DEDUCTIBLE</strong>: for each unrelated MECHANICAL BREAKDOWN or FAILURE, YOU will be responsible for the DEDUCTIBLE amount as shown in the Coverage section above and for any other costs not covered by this CONTRACT.</p>
...
<p><strong>YOUR RESPONSIBILITIES: &nbsp;</strong>To keep this Contract valid, YOU must:</p>
...
<p>Covered Parts AND Components: <em>(Inclusions)</em></p>
<p>The Coverage YOU selected is identified in the Coverage section above. The components WE cover are separated into three distinct groups for which YOU can request coverage. These groups are described as: Powertrain, Hydraulic Systems and Platform.</p>
...
<ol start="3">
<li>Any pre-existing condition or Mechanical Breakdown caused by a condition known to YOU or where there is sufficient reason to believe the breakdown was the result of a pre-existing condition, on or prior to the Contract Purchase &nbsp;&nbsp;&nbsp;&nbsp;Date.</li>
</ol>
...
<li>Body Parts subject to wear, such as: trim, moldings, sheet metal, door latches, handles or hinges, lock cylinders, bed liners, upholstery, vinyl, canvass, doors, glass, windows, mirrors, mirror brackets, and weather stripping</li>
</ol>
...
<ol start="17">
<li>The cost of establishing preventative procedures or the cost of recall by the Manufacturer of the covered</li>
</ol>
<p>Equipment or any part thereof</p>
...
<ol start="21">
<li>Any wastage of material, wearing away or wearing out of any part of the Equipment caused by or resulting from ordinary usage, rust, boiler scale, other deposits, erosion, corrosion, cavitation or deterioration due to chemical or atmospheric conditions, or other scratching of painted or polished surfaces and or other environmental conditions</li>
</ol>
...
<ol start="26">
<li>Any engine damage resulting from the ingestion of dust and/or water through the engine's air intake system</li>
</ol>
...
<p><strong><u>Dispute Resolution Process</u></strong></p>
 
<p>In the event of any dispute concerning the interpretation of the Contract or OUR performance, WE recommend that you consider the following actions, in order, prior to requesting arbitration.</p>
...
<p>Reasonable people can disagree. This provision is intended to create an efficient and cost effective way of resolving disputes reasonably and respectfully. <u>WE will admit when WE are wrong, say WE are sorry and then do what WE</u> <u>can to make things right.</u></p>
...
<p>It is <strong>YOUR </strong>responsibility to protect the Equipment from further damage,</p>
 
<p>It is <strong>YOUR </strong>responsibility to notify the Administrator before starting any repairs</p>
 
 
<p>It is then <strong>YOUR </strong>responsibility to file the claim with the Administrator</p>
 
<p><strong>Step1 <em>(Obtain authorization to start the repair): </em></strong>If the Failure is deemed to be a covered by the Contract, the repair facility should submit a repair estimate via the AgGuard website (<a href="http://www.agguard.com/claims"><strong>www.agguard.com/claims</strong>).</a> The repair estimate should be filed with AgGuard within 90 days of Failure. If the repair estimate is over one thousand five hundred dollars ($1,500.00) or if diagnostic cost is over ($500) then the repair facility must contact AgGuard before proceeding with the repair-unless a higher amount for that repair facility has been agreed to and authorized by AgGuard in writing. Failure to pre-notify US could disqualify the Claim.</p>
 
 
<p>YOU must authorize any work on the Machine; therefore, all repair options and considerations should be presented to YOU, no matter what the estimated cost, before any work is done. If We authorize a repair, you must also authorize the repair before the facility begins work. After all, it is your Machine.</p>
 
<p><strong>Step2:<em>(Submit the Claim): </em></strong>The section below "How to Make a Claim" provides specific directions on how to successfully submit a claim and receive quick resolution.</p>
 
<p><strong>Step3: <em>(Get Paid): </em></strong>Upon receipt, OUR staff will carefully review the Claim. If there are no apparent discrepancies, questions, or missing information, a member of the claims staff will determine that:</p>
...
<p>When requesting authorization to begin work or submitting the Claim on the Ag Guard website ( <a href="http://www.agguard.com/claims)"><strong>www.agguard.com/claims</strong>)</a> YOU must provide all of the required information WE request. In addition, YOU must provide a detailed analysis of the Failure that describes:</p>
 
<p><strong><u>Situation</u></strong><u>:</u> When the Machine failed, <strong>where </strong>the Equipment was located and <strong>how </strong>the Failure occurred. (<em>For example: On June 22, 2012, on flat, dry ground while planting, the hydraulics would not respond.)</em></p>
 
<p><strong><u>Cause</u></strong>: Why the Failure occurred and <strong>what </strong>failed, if known. <strong>Identify the specific manufacturing defect</strong>. Avoid oversimplifications, such as "failed" or "leaked," without an explanation of what caused the Failure and why the Failure should be covered. If the cause cannot be determined, indicate this and provide information proving the Machine was properly maintained and used as designed. (<em>For example: the hydraulics failed because of a bad main seal causing instant loss of pressure.)</em></p>
 
<p><strong><u>Recommendation for repair</u></strong>:</p>
<p>In addition to describing the strategy for repair, this should also include a repair estimate detailing parts and prices</p>
<p>along with the estimated labor and rates. If possible, photos should be attached showing the Failure and any affected parts.</p>
 
<p><strong><u>How could this Failure have been avoided</u></strong>:</p>
<p>Rule out any service bulletins, field bulletins, recalls, programs, etc. related to the component and group. By better understanding the Failure, a repair can be made that is efficient, effective and will not lead to a repeat Failure. This feedback is also valuable, because WE want to help develop best practices for the repair and give advice to manufactures on product reliability. <em>(For example: The seal does not appear to be sturdy enough for the operating pressures that are typical with this pump. It is unlikely that the owner or any service could have prevented this Failure. The pump needs better seals. No bulletins or recalls address this issue.)</em></p>
...
<p>Diagrams from a parts book and identification of Failed parts/components; Manufacturer's flat rate or time estimate for repair;</p>
...
<p><strong><u>Labor Charges</u></strong></p>
...
<p>Pictures should generally be taken as close as possible to the part to show detail.</p>
 
<p>Digital photo's should be sent to US as .PJG files, (They can also be mailed if necessary).</p>
 
<p><strong>Manufacturer's Warranty Period, Recalls, AND Product Improvements</strong></p>
 
<p>Our coverage begins the day after the Manufacturer's warranty expires. If a unit is still under factory coverage and a</p>
<p>Claim occurs, it must be filed with the Manufacturer.</p>
 
<p>If the Manufacturer's warranty period has expired and a Claim is covered by a Manufacturer recall or Product Support Program, the Claim must be filed with the Manufacturer. Our coverage will not apply in such an instance. If a Manufacturer's recall or Product Support Program only partially covers a Claim, the Claim may be submitted to US for review. We will require a full explanation of what the Manufacturer allowed along with a copy of the Manufacturer's settlement statement.</p>
 
<p><strong><u>Replacement versus Repair Cost</u></strong></p>
 
<p>We allow the use of exchange components under certain circumstances. The guidelines are as follows: The cost to repair the failed component meets or exceeds 70% of the value of a remanufactured or new exchange component. If the repair cost falls under 70%, the failed component should be repaired and WE will pay only for parts and labor associated with the actual failed parts. In an exchange unit WE will not pay for parts which have not failed, but due to normal wear and tear need to be replaced to bring the component back to new exchange specifications.</p>
 
 
<p><strong><u>Save the Old Parts, Fluids and Cores</u></strong></p>
 
<p>Save the Failed component and parts related to the Failure until the Claim is resolved. Occasionally WE may need to have parts sent to US. We will ask for these parts within 30 days of a Claim being received. We will return the parts as quickly as possible. If there is a rush to get the parts back, notify US and WE will ship the parts back to you within three business days of receiving them. Save involved/related compartment fluid samples until the Claim is resolved in case the samples are needed to determine the cause of the Failure. We may direct you to deliver a core for rebate/deposit or to reduce the cost of the Claim if the core has residual value.</p>
 
<p><strong>CONTACT INFORMATION</strong></p>
 
<p>AgGuard</p>
<p>21295 Hollingsworth Rd&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Wild Jay, Inc., as Guarantor for AgGuard</p>
<p>Tonganoxie, KS 66086&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;PO Box 2033</p>
<p>Phone 816.223.1978&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Mission, Kansas 66201-1033</p>
<p>AgGuard.com&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;WildJinc.com</p>
<p><a href="mailto:info@agguard.com">Customer Service: info@agguard.com</a></p>
...
<p>It is beneficial to ensure the purchaser has a clear understanding of the Contract's terms and conditions and the</p>
