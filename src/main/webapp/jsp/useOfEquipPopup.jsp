<div id="useOfEquipPopup" class="agg_popup modal-dialog" style="z-index:10001; display:none; position:absolute;">
	...
	<div class="modal-body">
		<form class="form-horizontal" role="form" ng-submit="submitEditEquipment()">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="equipName" name="equipName" ng-model="useOfEquip.equipName" placeholder="" class="form-control" required="required" readonly="readonly">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="discount" name="discount" ng-model="useOfEquip.discount" placeholder="" class="form-control" required="required" readonly="readonly">
				</div>
			</div>
