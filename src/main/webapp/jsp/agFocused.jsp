...
<div class="row">
		...
		<p class="mar-bot" style="color:black; font-size:16px;">The Ag industry is changing, and the speed of change seems to be accelerating.  So, we focus on what we know best.</p>
			<p class="mar-bot" style="color:black; font-size:16px;">The Ag industry is changing, and the speed of change seems to be accelerating.  So, we focus on what we know best.</p>
			
			<p class="mar-bot" style="color:black; font-size:16px;">Whether it is how to diagnose a failure, source a part or understand the reliability characteristics of a particular model, we can help.</p>   
					  </form>		
                </div>
            </div>
          </div>
